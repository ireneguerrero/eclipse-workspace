package dragon.ball.irene.yoportuhijoMA.TO;

public class DragonBallIrene {
	...
	public static void main(String[] args) {
		...
		public class EjercicioDragonBall {
		    ...
		    public static void main(String[] args) {
		        ...
		        System.out.println("El poder de PantaLón en forma base es de: "+(PBPanta+PBLón)*1.5);
		        
		        //int poderFusiónSSJ2=(PBPanta+PBLón)*100*3;
		        System.out.println("El poder de PantaLón en SSJ2 es de: "+(PBPanta+PBLón)*100*3);
		        
		        //float fusiónErrada=((PBPanta/2)+(PBLón/2)*0.7;
		        System.out.println("El poder de PantaLón mal fusionado es de: "+(PBPanta/2+PBLón/2)*0.7);
		        
		        //float mediaSSJ1=((PBPanta*50)+(PBLón*50))/2;
		        System.out.println("La media de poder de Panta y Lón en SSJ1 es: "+(PBPanta*50+PBLón*50)/2);
